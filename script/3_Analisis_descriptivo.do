...
label var factornd07 "Factor de expansión individuos Sumaria"

	
* Generar Departamentos (lima incluye callao)
clonevar dpto = dpto1		
replace dpto=15 if dpto==7 // dpto==7 corresponde al Callao
lab var dpto "Departamentos (Lima incluye Callao)"

* Utilizaremos los deflactores	
merge m:1 aniorec dpto using "deflactores_base2020_new.dta"
drop if _m == 2
drop _m
...
keep if hpan0708==1 | hpan0809==1 | hpan0910==1 |hpan1011==1 
xtdescribe
